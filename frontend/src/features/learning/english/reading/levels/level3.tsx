  ...
  const fetchWord = async () => {
    try {
      const res = await axios.get(
        "http://localhost:5002/english/reading/get-word?level=3"
      );
    ...
    <SceneBackground>
        ...
        <div className="level-container">
          <div className="level-card fade-in-up">
            ...
            <h1 className="level-title">🎤 Reading Practice — Level 3</h1>
            <p className="level-desc">
              Read the word aloud and let the system check your pronunciation.
            </p>
...
export default ReadingEnglishLevel3;